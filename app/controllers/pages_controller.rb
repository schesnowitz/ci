class PagesController < ApplicationController
  ...
  # POST /pages.json
  def create
    @page = @template_one.pages.new(page_params) 

    respond_to do |format|
      if @page.save
        format.html { redirect_to template_one_page_path(@template_one, @page), notice: 'Page was successfully created.' }
  ...
  def destroy
    @page.destroy
    respond_to do |format|
      format.html { redirect_to template_one_pages_url, notice: 'Page was successfully destroyed.' }
