class AppSettingsController < ApplicationController
  ...
  private
    ...
    def app_setting_params
      params.require(:app_setting).permit(:tab_name, :theme_name, :front_end_color, :app_title, :app_email_1, :app_email_2, :app_email_title_1, :app_email_title_2, :navbar_color)
    end
end
